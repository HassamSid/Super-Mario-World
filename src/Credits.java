...
public class Credits {
    ...
    String credits ="/GameAssets/GFX/Credits/creditsbg.png";
    String addressBackground ="/GameAssets/GFX/MainMenu/bgeven.png";
    ...
    Credits(){
        ...
        credit = new JLabel();
        credit.setIcon(new ImageIcon(getClass().getResource(credits)));
